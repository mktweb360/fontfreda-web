...
<PawPrint className="w-6 h-6 text-primary flex-shrink-0" aria-hidden="true" />
<div className="flex flex-col leading-none">
<span className="text-xl font-serif italic text-foreground">Fontfreda</span>
<span className="text-[8px] uppercase tracking-widest text-muted-foreground whitespace-nowrap">Residencia Canina y Felina</span>
</div>
</div>
