        ...
        <section className="py-20 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+34937790311" onClick={() => { import("@/lib/conversionTracking").then((m) => m.trackPhoneClick("residencia_felina_cta_final")); }}>
                <Button className="bg-primary-foreground hover:bg-primary-foreground/90 text-primary px-8 py-6 text-base">
                  {t.callNow}
                </Button>
              </a>
              <a href="https://wa.me/34609732211" target="_blank" rel="noopener noreferrer" onClick={() => { import("@/lib/conversionTracking").then((m) => m.trackWhatsAppClick("residencia_felina_cta_final")); }}>
                <Button
                  variant="outline"
