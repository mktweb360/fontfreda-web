...
export default function LargaEstancia() {
  ...
  const t = isEnglish ? {
    ...
    faqItems: [
      ...
      { question: "What documentation do I need?", answer: "Your dog must be vaccinated (pentavalent, heptavalent or kennel cough up to date), dewormed with external protection (anti-parasite pipette or collar), microchipped and, if necessary by regulation, have third-party insurance. We carry out a prior assessment." },
    ],
    ...
    faqItems: [
      ...
      { question: "¿Qué documentación necesito?", answer: "Tu perro debe estar vacunado (pentavalente, heptavalente o tos de perrera al día), desparasitado con protección externa (pipeta o collar antiparásitos), tener microchip y, si es necesario según normativa, contar con el seguro a terceros. Realizamos una valoración previa." },
    ],
        ...
        <section className="py-20 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+34937790311" onClick={() => { import("@/lib/conversionTracking").then((m) => m.trackPhoneClick("larga_estancia_cta_final")); }}>
                <Button className="bg-primary-foreground hover:bg-primary-foreground/90 text-primary px-8 py-6 text-base">
                  {t.callNow}
                </Button>
              </a>
              <a href="https://wa.me/34609732211" target="_blank" rel="noopener noreferrer" onClick={() => { import("@/lib/conversionTracking").then((m) => m.trackWhatsAppClick("larga_estancia_cta_final")); }}>
                <Button
                  variant="outline"
