...
const SESSION_KEY = "fontfreda_form_guarderia";
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              ...
              <div>
                ...
                <p className="text-foreground text-lg leading-relaxed mb-4">
                  {isEnglish
                    ? "I'm Luis, owner of Fontfreda. I've been caring for dogs for over 40 years at our family estate in the Alt Penedès, just 30 minutes from Barcelona."
                    : "Soy Luis, propietario de Fontfreda. Llevo más de 40 años cuidando perros en nuestra finca familiar en el Alt Penedès, a solo 30 minutos de Barcelona."}
                </p>
