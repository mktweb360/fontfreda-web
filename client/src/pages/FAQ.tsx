...
const faqItemsES: FAQItem[] = [
  ...
  { id: "c1", categoria: "canina", pregunta: "¿Cuál es la edad mínima para un perro?", respuesta: "Aceptamos cachorros a partir de 5 meses de edad, siempre que estén correctamente vacunados. Para cachorros muy jóvenes, realizamos una valoración especial." },
  { id: "c2", categoria: "canina", pregunta: "¿Cuáles son los requisitos de ingreso para perros?", respuesta: "Tu perro debe estar vacunado (pentavalente, heptavalente o tos de perrera al día), desparasitado con protección externa (pipeta o collar antiparásitos), tener microchip y, si es necesario según normativa, contar con el seguro a terceros correspondiente." },
  ...
  { id: "f2", categoria: "felina", pregunta: "¿Cuáles son los requisitos para gatos?", respuesta: "Tu gato debe estar vacunado (trivalente y leucemia felina al día), desparasitado y tener la pipeta antiparásitos aplicada. Microchip obligatorio." },
...
const faqItemsEN: FAQItem[] = [
  ...
  { id: "c1", categoria: "canina", pregunta: "What is the minimum age for a dog?", respuesta: "We accept puppies from 5 months of age, as long as they are correctly vaccinated. For very young puppies, we carry out a special assessment." },
  { id: "c2", categoria: "canina", pregunta: "What are the admission requirements for dogs?", respuesta: "Your dog must be vaccinated (pentavalent, heptavalent or kennel cough up to date), dewormed with external protection (anti-parasite pipette or collar), microchipped and, if necessary by regulation, have the corresponding third-party insurance." },
  ...
  { id: "f2", categoria: "felina", pregunta: "What are the requirements for cats?", respuesta: "Your cat must be vaccinated (trivalent and feline leukemia up to date), dewormed and have applied an anti-parasite pipette. Microchip mandatory." },
