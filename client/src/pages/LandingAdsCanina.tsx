...
export default function LandingAdsCanina() {
  ...
  const t = isEnglish
    ? {
        seoTitle: "Dog Boarding Barcelona | Family Accommodation for Dogs | Fontfreda",
        seoDescription:
        ...
        ctaPrimary: "Book Your Dog's Stay",
        ctaSecondary: "Free Assessment",
        ctaCall: "Call Now",
        price: "From €20/day",
        testimonialText: '"My dog comes back happy and tired. Best investment ever!"',
        testimonialAuthor: "María G.",
    ...
    : {
        seoTitle: "Residencia Canina Barcelona | Alojamiento Familiar para Perros | Fontfreda",
        seoDescription:
        ...
        benefits: [
          "Entorno familiar — no una jaula ni perrera",
        ...
        price: "Desde 20€/día",
        testimonialText: '"Mi perro vuelve feliz y cansado. ¡La mejor inversión!"',
        testimonialAuthor: "María G.",
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      trackContactFormSubmission({
        servicio: "residencia-canina",
        origen: "landing_canina_barcelona",
      });
      ...
      <main className="flex-grow">
        ...
        <section className="relative py-20 overflow-hidden">
          <img
            ...
            alt={
              isEnglish
                ? "Dog enjoying Fontfreda canine boarding in Barcelona"
                : "Perro disfrutando de la residencia canina Fontfreda en Barcelona"
            }
            ...
            <div className="max-w-2xl mx-auto text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                ...
                <a
                  ...
                  onClick={() => handlePhoneClick("landing_canina_hero")}
                >
                  <Button
                    size="lg"
                    variant="outline"
        ...
        <section className="py-20 bg-gradient-to-r from-primary to-primary/80 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="tel:+34937790311"
                onClick={() => handlePhoneClick("landing_canina_cta_final")}
              >
                <Button
                  size="lg"
                  variant="outline"
